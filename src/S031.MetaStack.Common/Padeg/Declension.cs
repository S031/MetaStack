...
/// <summary>
	...
	public static class Declension
	{
		...
		{
			string[] fomitchi = { "ильич", "кузьмич", "фомич", "лукич" };
		...
		/// <param name="z5"></param>
		/// <returns></returns>
		public static string GetDeclension(string FIO, DeclensionCase declensionCase /*=2*/, DeclensionGender gender, string part, int z5)
		{
			FIO.NullTest(nameof(FIO));
