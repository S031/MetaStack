...
namespace S031.MetaStack.Data
{
	...
	public static class MdbTypeMap
	{
		...
		static readonly ReadOnlyCache<Type, MdbTypeInfo> _listTypesInfo = new ReadOnlyCache<Type, MdbTypeInfo>(
		...
		public static MdbTypeInfo GetTypeInfo(this MdbType t)
			=> _listTypesInfo[_listTypes[(int)t]];
		public static MdbTypeInfo GetTypeInfo(Type t) 
			=> _listTypesInfo.TryGetValue(t, out MdbTypeInfo v) ? v : _listTypesInfo[typeof(object)];
		public static Type GetType(MdbType t) 
			=> _listTypes[(int)t];
		public static Type GetType(Type t) 
			=> _listTypesInfo.Contains(t) ? t : typeof(object);
		public static Type GetType(string typeName) 
			=> GetType(typeName, typeof(object));
		public static Type GetType(string typeName, Type defaultType) 
			=> Enum.TryParse<MdbType>(typeName, true, out MdbType t) ? _listTypes[(int)t] : defaultType;
