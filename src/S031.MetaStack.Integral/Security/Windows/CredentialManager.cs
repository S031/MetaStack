...
namespace S031.MetaStack.Security
{
	public static class CredentialManager
	{
		...
		private static NetworkCredential ReadCredential(CREDENTIAL credential)
		{
			...
			return new NetworkCredential(userName, secret);
		}
		...
		public static IReadOnlyList<NetworkCredential> EnumerateCrendentials()
		{
