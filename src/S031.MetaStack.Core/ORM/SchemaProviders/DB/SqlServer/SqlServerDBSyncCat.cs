...
{
	partial class SqlServerDBSync : ISchemaDBSync
	{
		static readonly Dictionary<string, string> _s = new Dictionary<string, string>()
		{
			{"SQLVersion",  @"select SERVERPROPERTY('ProductVersion') AS ProductVersion"},

			{"TestSchema",  @"Select Name From sys.schemas Where name = 'SysCat'"},
			...
			{"GetCurrentSchema",  @"Select schema_name()"},

			{"GetTableSchema",  @"SysCat.Get_TableSchema"},

			{"GetTableSchemaXml",  @"SysCat.Get_TableSchema_xml"},

			{"GetParentRelations",  @"SysCat.Get_ParentRelations"},

			{"AddSysAreas",  @"SysCat.Add_SysAreas"},

			{"AddSysSchemas",  @"SysCat.Add_SysSchemas"},

			{"DelSysSchemas",  @"SysCat.Del_SysSchemas"},

			{"StateSysSchemas",  @"SysCat.State_SysSchemas"},
