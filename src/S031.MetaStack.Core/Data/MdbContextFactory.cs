...
{
	/// <summary>
	/// !!! Разделить контексты с постоянным соединением (SQLite) и создаваемые по звапросу (SQLServer и т.д)
	/// деградация производительности 10 раз
	...
	/// или сервисы с постоянным соединением создавать как singletone
	/// </summary>
