...
namespace S031.MetaStack.Core.App
{
	public static class AppHostExtensions
	{
		...
		/// <returns></returns>
		//public static Task StopAsync(this IAppHost host, TimeSpan timeout)
		//{
		...
		/// </summary>
		/// <param name="host">The running <see cref="IAppHost"/>.</param>
		public static void WaitForShutdown(this IAppHost host)
		{
		...
		public static async Task WaitForShutdownAsync(this IAppHost host, CancellationToken token = default)
		{
		...
		private static async Task RunAsync(this IAppHost host, CancellationToken token, string shutdownMessage)
		{
			using (host)
			{
		...
		private static async Task WaitForTokenShutdownAsync(this IAppHost host, CancellationToken token)
		{
			var applicationLifetime = host.Services.GetService<IApplicationLifetime>();
